...
print (banner)
sleep(4)
print ('\033[1;36m\nEx : https://yourblog.blogspot.com/2018/09/LaughSec-Team.html?=1')
sleep(2)
url = input('\033[1;31mMasukkan URL Blog : ')
jml = int(input('Jumlah Visit: '))
time = int(input('Jeda : '))
print ('Otw visit mank.... ......')
sleep(2)
for i in range(1, jml):
    user_agent = random.choice(user_agent_list)
    headers = {'User-Visit': user_agent}
    proxies_a = random.choice(proxies_list)
    proxies = {'http': proxies_a}
    with requests.Session() as c:
         r = c.get (url, headers=headers, proxies=proxies)
         if r.status_code == requests.codes.ok:
            print ('\033[1;36m[\033[1;0m', i, '\033[1;36m] \033[1;34m[User-Visit]\033[1;0m ✔ \033[1;32m[Status]\033[1;0m', r.status_code, 'Ok \033[1;33m[Visit]\033[1;0m ==>\033[1;91m SUKSES Mank')
            sleep(time)
         else:
            print ('\nAda kesalahan.! Coba cek ulang url blog')
print ('Visit Selesai')
